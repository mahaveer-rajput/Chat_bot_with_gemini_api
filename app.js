...
// API setup
const API_KEY = "AIzaSyAEIZALDo_Sb_AbwL9gqTJviYrYvq_7OxY";
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try{
        ...
        messageElement.style.color = "red"
          ...
          // Reset file data, removing thinking indicator and scroll to bottom
        userData.file = {};  
...
// create and display user message 
    ...
    // simulate bot response with thininking indicator after a delay
    setTimeout (() => {
...
fileInput.addEventListener("change", (event) => {
    ...
    if (file) {
        ...
        reader.onload = (e) => {
            // Ensure the fileUploadWrapper contains an img element
